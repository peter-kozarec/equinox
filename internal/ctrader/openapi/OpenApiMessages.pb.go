...
const file_OpenApiMessages_proto_rawDesc = "" +
	...
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_APPLICATION_AUTH_REQR\vpayloadType\x12\x1a\n" +
	"\bclientId\x18\x02 \x02(\tR\bclientId\x12\"\n" +
	"\fclientSecret\x18\x03 \x02(\tR\fclientSecret\"q\n" +
	"\x19ProtoOAApplicationAuthRes\x12T\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_APPLICATION_AUTH_RESR\vpayloadType\"\xbd\x01\n" +
	"\x15ProtoOAAccountAuthReq\x12P\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x19PROTO_OA_ACCOUNT_AUTH_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12 \n" +
	"\vaccessToken\x18\x03 \x02(\tR\vaccessToken\"\x9b\x01\n" +
	"\x15ProtoOAAccountAuthRes\x12P\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x19PROTO_OA_ACCOUNT_AUTH_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xa8\x02\n" +
	"\x0fProtoOAErrorRes\x12I\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x12PROTO_OA_ERROR_RESR\vpayloadType\x120\n" +
	...
	"\x17maintenanceEndTimestamp\x18\x05 \x01(\x03R\x17maintenanceEndTimestamp\x12\x1e\n" +
	"\n" +
	"retryAfter\x18\x06 \x01(\x04R\n" +
	"retryAfter\"\x8f\x01\n" +
	"\x1cProtoOAClientDisconnectEvent\x12W\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType: PROTO_OA_CLIENT_DISCONNECT_EVENTR\vpayloadType\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\"\xd4\x01\n" +
	"$ProtoOAAccountsTokenInvalidatedEvent\x12`\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:)PROTO_OA_ACCOUNTS_TOKEN_INVALIDATED_EVENTR\vpayloadType\x122\n" +
	"\x14ctidTraderAccountIds\x18\x02 \x03(\x03R\x14ctidTraderAccountIds\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\"`\n" +
	"\x11ProtoOAVersionReq\x12K\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x14PROTO_OA_VERSION_REQR\vpayloadType\"z\n" +
	"\x11ProtoOAVersionRes\x12K\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x14PROTO_OA_VERSION_RESR\vpayloadType\x12\x18\n" +
	"\aversion\x18\x02 \x02(\tR\aversion\"\xf9\a\n" +
	"\x12ProtoOANewOrderReq\x12M\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x16PROTO_OA_NEW_ORDER_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	"\bsymbolId\x18\x03 \x02(\x03R\bsymbolId\x12/\n" +
	"\torderType\x18\x04 \x02(\x0e2\x11.ProtoOAOrderTypeR\torderType\x12/\n" +
	"\ttradeSide\x18\x05 \x02(\x0e2\x11.ProtoOATradeSideR\ttradeSide\x12\x16\n" +
	"\x06volume\x18\x06 \x02(\x03R\x06volume\x12\x1e\n" +
	"\n" +
	"limitPrice\x18\a \x01(\x01R\n" +
	"limitPrice\x12\x1c\n" +
	"\tstopPrice\x18\b \x01(\x01R\tstopPrice\x12G\n" +
	"\vtimeInForce\x18\t \x01(\x0e2\x13.ProtoOATimeInForce:\x10GOOD_TILL_CANCELR\vtimeInForce\x120\n" +
	"\x13expirationTimestamp\x18\n" +
	" \x01(\x03R\x13expirationTimestamp\x12\x1a\n" +
	"\bstopLoss\x18\v \x01(\x01R\bstopLoss\x12\x1e\n" +
	"\n" +
	"takeProfit\x18\f \x01(\x01R\n" +
	"takeProfit\x12\x18\n" +
	"\acomment\x18\r \x01(\tR\acomment\x12,\n" +
	"\x11baseSlippagePrice\x18\x0e \x01(\x01R\x11baseSlippagePrice\x12*\n" +
	"\x10slippageInPoints\x18\x0f \x01(\x05R\x10slippageInPoints\x12\x14\n" +
	"\x05label\x18\x10 \x01(\tR\x05label\x12\x1e\n" +
	"\n" +
	"positionId\x18\x11 \x01(\x03R\n" +
	"positionId\x12$\n" +
	"\rclientOrderId\x18\x12 \x01(\tR\rclientOrderId\x12*\n" +
	"\x10relativeStopLoss\x18\x13 \x01(\x03R\x10relativeStopLoss\x12.\n" +
	"\x12relativeTakeProfit\x18\x14 \x01(\x03R\x12relativeTakeProfit\x12.\n" +
	"\x12guaranteedStopLoss\x18\x15 \x01(\bR\x12guaranteedStopLoss\x12*\n" +
	"\x10trailingStopLoss\x18\x16 \x01(\bR\x10trailingStopLoss\x12O\n" +
	"\x11stopTriggerMethod\x18\x17 \x01(\x0e2\x1a.ProtoOAOrderTriggerMethod:\x05TRADER\x11stopTriggerMethod\"\xa5\x04\n" +
	"\x15ProtoOAExecutionEvent\x12O\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x18PROTO_OA_EXECUTION_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12;\n" +
	"\rexecutionType\x18\x03 \x02(\x0e2\x15.ProtoOAExecutionTypeR\rexecutionType\x12,\n" +
	"\bposition\x18\x04 \x01(\v2\x10.ProtoOAPositionR\bposition\x12#\n" +
	"\x05order\x18\x05 \x01(\v2\r.ProtoOAOrderR\x05order\x12 \n" +
	"\x04deal\x18\x06 \x01(\v2\f.ProtoOADealR\x04deal\x12P\n" +
	"\x14bonusDepositWithdraw\x18\a \x01(\v2\x1c.ProtoOABonusDepositWithdrawR\x14bonusDepositWithdraw\x12A\n" +
	"\x0fdepositWithdraw\x18\b \x01(\v2\x17.ProtoOADepositWithdrawR\x0fdepositWithdraw\x12\x1c\n" +
	"\terrorCode\x18\t \x01(\tR\terrorCode\x12$\n" +
	"\risServerEvent\x18\n" +
	" \x01(\bR\risServerEvent\"\xb5\x01\n" +
	"\x15ProtoOACancelOrderReq\x12P\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x19PROTO_OA_CANCEL_ORDER_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x18\n" +
	"\aorderId\x18\x03 \x02(\x03R\aorderId\"\xac\x05\n" +
	"\x14ProtoOAAmendOrderReq\x12O\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x18PROTO_OA_AMEND_ORDER_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x18\n" +
	"\aorderId\x18\x03 \x02(\x03R\aorderId\x12\x16\n" +
	"\x06volume\x18\x04 \x01(\x03R\x06volume\x12\x1e\n" +
	"\n" +
	"limitPrice\x18\x05 \x01(\x01R\n" +
	"limitPrice\x12\x1c\n" +
	"\tstopPrice\x18\x06 \x01(\x01R\tstopPrice\x120\n" +
	"\x13expirationTimestamp\x18\a \x01(\x03R\x13expirationTimestamp\x12\x1a\n" +
	"\bstopLoss\x18\b \x01(\x01R\bstopLoss\x12\x1e\n" +
	"\n" +
	"takeProfit\x18\t \x01(\x01R\n" +
	"takeProfit\x12*\n" +
	"\x10slippageInPoints\x18\n" +
	" \x01(\x05R\x10slippageInPoints\x12*\n" +
	"\x10relativeStopLoss\x18\v \x01(\x03R\x10relativeStopLoss\x12.\n" +
	"\x12relativeTakeProfit\x18\f \x01(\x03R\x12relativeTakeProfit\x12.\n" +
	"\x12guaranteedStopLoss\x18\r \x01(\bR\x12guaranteedStopLoss\x12*\n" +
	"\x10trailingStopLoss\x18\x0e \x01(\bR\x10trailingStopLoss\x12O\n" +
	"\x11stopTriggerMethod\x18\x0f \x01(\x0e2\x1a.ProtoOAOrderTriggerMethod:\x05TRADER\x11stopTriggerMethod\"\xb9\x03\n" +
	"\x1bProtoOAAmendPositionSLTPReq\x12W\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType: PROTO_OA_AMEND_POSITION_SLTP_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1e\n" +
	"\n" +
	"positionId\x18\x03 \x02(\x03R\n" +
	"positionId\x12\x1a\n" +
	"\bstopLoss\x18\x04 \x01(\x01R\bstopLoss\x12\x1e\n" +
	"\n" +
	"takeProfit\x18\x05 \x01(\x01R\n" +
	"takeProfit\x12.\n" +
	"\x12guaranteedStopLoss\x18\a \x01(\bR\x12guaranteedStopLoss\x12*\n" +
	"\x10trailingStopLoss\x18\b \x01(\bR\x10trailingStopLoss\x12W\n" +
	"\x15stopLossTriggerMethod\x18\t \x01(\x0e2\x1a.ProtoOAOrderTriggerMethod:\x05TRADER\x15stopLossTriggerMethod\"\xd7\x01\n" +
	"\x17ProtoOAClosePositionReq\x12R\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1bPROTO_OA_CLOSE_POSITION_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1e\n" +
	"\n" +
	"positionId\x18\x03 \x02(\x03R\n" +
	"positionId\x12\x16\n" +
	"\x06volume\x18\x04 \x02(\x03R\x06volume\"\xbc\x02\n" +
	"\x1dProtoOATrailingSLChangedEvent\x12Y\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\"PROTO_OA_TRAILING_SL_CHANGED_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1e\n" +
	"\n" +
	"positionId\x18\x03 \x02(\x03R\n" +
	"positionId\x12\x18\n" +
	"\aorderId\x18\x04 \x02(\x03R\aorderId\x12\x1c\n" +
	"\tstopPrice\x18\x05 \x02(\x01R\tstopPrice\x126\n" +
	"\x16utcLastUpdateTimestamp\x18\x06 \x02(\x03R\x16utcLastUpdateTimestamp\"\x97\x01\n" +
	"\x13ProtoOAAssetListReq\x12N\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x17PROTO_OA_ASSET_LIST_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xbc\x01\n" +
	"\x13ProtoOAAssetListRes\x12N\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x17PROTO_OA_ASSET_LIST_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12#\n" +
	"\x05asset\x18\x03 \x03(\v2\r.ProtoOAAssetR\x05asset\"\xda\x01\n" +
	"\x15ProtoOASymbolsListReq\x12P\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x19PROTO_OA_SYMBOLS_LIST_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12=\n" +
	"\x16includeArchivedSymbols\x18\x03 \x01(\b:\x05falseR\x16includeArchivedSymbols\"\x88\x02\n" +
	"\x15ProtoOASymbolsListRes\x12P\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x19PROTO_OA_SYMBOLS_LIST_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12+\n" +
	"\x06symbol\x18\x03 \x03(\v2\x13.ProtoOALightSymbolR\x06symbol\x12>\n" +
	"\x0earchivedSymbol\x18\x04 \x03(\v2\x16.ProtoOAArchivedSymbolR\x0earchivedSymbol\"\xb6\x01\n" +
	"\x14ProtoOASymbolByIdReq\x12P\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x19PROTO_OA_SYMBOL_BY_ID_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	"\bsymbolId\x18\x03 \x03(\x03R\bsymbolId\"\x82\x02\n" +
	"\x14ProtoOASymbolByIdRes\x12P\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x19PROTO_OA_SYMBOL_BY_ID_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12&\n" +
	"\x06symbol\x18\x03 \x03(\v2\x0e.ProtoOASymbolR\x06symbol\x12>\n" +
	"\x0earchivedSymbol\x18\x04 \x03(\v2\x16.ProtoOAArchivedSymbolR\x0earchivedSymbol\"\xf4\x01\n" +
	"\x1eProtoOASymbolsForConversionReq\x12Z\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:#PROTO_OA_SYMBOLS_FOR_CONVERSION_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\"\n" +
	"\ffirstAssetId\x18\x03 \x02(\x03R\ffirstAssetId\x12 \n" +
	"\vlastAssetId\x18\x04 \x02(\x03R\vlastAssetId\"\xdb\x01\n" +
	"\x1eProtoOASymbolsForConversionRes\x12Z\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:#PROTO_OA_SYMBOLS_FOR_CONVERSION_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12+\n" +
	"\x06symbol\x18\x03 \x03(\v2\x13.ProtoOALightSymbolR\x06symbol\"\xbf\x01\n" +
	"\x19ProtoOASymbolChangedEvent\x12T\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_SYMBOL_CHANGED_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	"\bsymbolId\x18\x03 \x03(\x03R\bsymbolId\"\xa2\x01\n" +
	"\x18ProtoOAAssetClassListReq\x12T\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_ASSET_CLASS_LIST_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xd6\x01\n" +
	"\x18ProtoOAAssetClassListRes\x12T\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_ASSET_CLASS_LIST_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x122\n" +
	"\n" +
	"assetClass\x18\x03 \x03(\v2\x12.ProtoOAAssetClassR\n" +
	"assetClass\"\x90\x01\n" +
	"\x10ProtoOATraderReq\x12J\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x13PROTO_OA_TRADER_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xb8\x01\n" +
	"\x10ProtoOATraderRes\x12J\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x13PROTO_OA_TRADER_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12&\n" +
	"\x06trader\x18\x03 \x02(\v2\x0e.ProtoOATraderR\x06trader\"\xca\x01\n" +
	"\x19ProtoOATraderUpdatedEvent\x12S\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1cPROTO_OA_TRADER_UPDATE_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12&\n" +
	"\x06trader\x18\x03 \x02(\v2\x0e.ProtoOATraderR\x06trader\"\xce\x01\n" +
	"\x13ProtoOAReconcileReq\x12M\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x16PROTO_OA_RECONCILE_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x126\n" +
	"\x16returnProtectionOrders\x18\x03 \x01(\bR\x16returnProtectionOrders\"\xe9\x01\n" +
	"\x13ProtoOAReconcileRes\x12M\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x16PROTO_OA_RECONCILE_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12,\n" +
	"\bposition\x18\x03 \x03(\v2\x10.ProtoOAPositionR\bposition\x12#\n" +
	"\x05order\x18\x04 \x03(\v2\r.ProtoOAOrderR\x05order\"\x97\x02\n" +
	"\x16ProtoOAOrderErrorEvent\x12Q\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1aPROTO_OA_ORDER_ERROR_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x05 \x02(\x03R\x13ctidTraderAccountId\x12\x1c\n" +
	"\terrorCode\x18\x02 \x02(\tR\terrorCode\x12\x18\n" +
	"\aorderId\x18\x03 \x01(\x03R\aorderId\x12\x1e\n" +
	"\n" +
	"positionId\x18\x06 \x01(\x03R\n" +
	"positionId\x12 \n" +
	"\vdescription\x18\a \x01(\tR\vdescription\"\xf7\x01\n" +
	"\x12ProtoOADealListReq\x12M\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x16PROTO_OA_DEAL_LIST_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12$\n" +
	"\rfromTimestamp\x18\x03 \x01(\x03R\rfromTimestamp\x12 \n" +
	"\vtoTimestamp\x18\x04 \x01(\x03R\vtoTimestamp\x12\x18\n" +
	"\amaxRows\x18\x05 \x01(\x05R\amaxRows\"\xd1\x01\n" +
	"\x12ProtoOADealListRes\x12M\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x16PROTO_OA_DEAL_LIST_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12 \n" +
	"\x04deal\x18\x03 \x03(\v2\f.ProtoOADealR\x04deal\x12\x18\n" +
	"\ahasMore\x18\x04 \x02(\bR\ahasMore\"\xdf\x01\n" +
	"\x13ProtoOAOrderListReq\x12N\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x17PROTO_OA_ORDER_LIST_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12$\n" +
	"\rfromTimestamp\x18\x03 \x01(\x03R\rfromTimestamp\x12 \n" +
	"\vtoTimestamp\x18\x04 \x01(\x03R\vtoTimestamp\"\xd6\x01\n" +
	"\x13ProtoOAOrderListRes\x12N\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x17PROTO_OA_ORDER_LIST_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12#\n" +
	"\x05order\x18\x03 \x03(\v2\r.ProtoOAOrderR\x05order\x12\x18\n" +
	"\ahasMore\x18\x04 \x02(\bR\ahasMore\"\xd5\x01\n" +
	"\x18ProtoOAExpectedMarginReq\x12S\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1cPROTO_OA_EXPECTED_MARGIN_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	"\bsymbolId\x18\x03 \x02(\x03R\bsymbolId\x12\x16\n" +
	"\x06volume\x18\x04 \x03(\x03R\x06volume\"\xf3\x01\n" +
	"\x18ProtoOAExpectedMarginRes\x12S\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1cPROTO_OA_EXPECTED_MARGIN_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12.\n" +
	"\x06margin\x18\x03 \x03(\v2\x16.ProtoOAExpectedMarginR\x06margin\x12 \n" +
	"\vmoneyDigits\x18\x04 \x01(\rR\vmoneyDigits\"\x85\x02\n" +
	"\x19ProtoOAMarginChangedEvent\x12T\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_MARGIN_CHANGED_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1e\n" +
	"\n" +
	"positionId\x18\x03 \x02(\x04R\n" +
	"positionId\x12\x1e\n" +
	"\n" +
	"usedMargin\x18\x04 \x02(\x04R\n" +
	"usedMargin\x12 \n" +
	"\vmoneyDigits\x18\x05 \x01(\rR\vmoneyDigits\"\xf5\x01\n" +
	"\x1dProtoOACashFlowHistoryListReq\x12Z\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:#PROTO_OA_CASH_FLOW_HISTORY_LIST_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12$\n" +
	"\rfromTimestamp\x18\x03 \x02(\x03R\rfromTimestamp\x12 \n" +
	"\vtoTimestamp\x18\x04 \x02(\x03R\vtoTimestamp\"\xf0\x01\n" +
	"\x1dProtoOACashFlowHistoryListRes\x12Z\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:#PROTO_OA_CASH_FLOW_HISTORY_LIST_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12A\n" +
	"\x0fdepositWithdraw\x18\x03 \x03(\v2\x17.ProtoOADepositWithdrawR\x0fdepositWithdraw\"\xab\x01\n" +
	"%ProtoOAGetAccountListByAccessTokenReq\x12`\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:)PROTO_OA_GET_ACCOUNTS_BY_ACCESS_TOKEN_REQR\vpayloadType\x12 \n" +
	"\vaccessToken\x18\x02 \x02(\tR\vaccessToken\"\xbd\x02\n" +
	"%ProtoOAGetAccountListByAccessTokenRes\x12`\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:)PROTO_OA_GET_ACCOUNTS_BY_ACCESS_TOKEN_RESR\vpayloadType\x12 \n" +
	"\vaccessToken\x18\x02 \x02(\tR\vaccessToken\x12G\n" +
	"\x0fpermissionScope\x18\x03 \x01(\x0e2\x1d.ProtoOAClientPermissionScopeR\x0fpermissionScope\x12G\n" +
	"\x11ctidTraderAccount\x18\x04 \x03(\v2\x19.ProtoOACtidTraderAccountR\x11ctidTraderAccount\"\x8f\x01\n" +
	"\x16ProtoOARefreshTokenReq\x12Q\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1aPROTO_OA_REFRESH_TOKEN_REQR\vpayloadType\x12\"\n" +
	"\frefreshToken\x18\x02 \x02(\tR\frefreshToken\"\xed\x01\n" +
	"\x16ProtoOARefreshTokenRes\x12Q\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1aPROTO_OA_REFRESH_TOKEN_RESR\vpayloadType\x12 \n" +
	...
	"\frefreshToken\x18\x05 \x02(\tR\frefreshToken\"\xf9\x01\n" +
	"\x18ProtoOASubscribeSpotsReq\x12S\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1cPROTO_OA_SUBSCRIBE_SPOTS_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	"\bsymbolId\x18\x03 \x03(\x03R\bsymbolId\x12:\n" +
	"\x18subscribeToSpotTimestamp\x18\x04 \x01(\bR\x18subscribeToSpotTimestamp\"\xa1\x01\n" +
	"\x18ProtoOASubscribeSpotsRes\x12S\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1cPROTO_OA_SUBSCRIBE_SPOTS_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xc1\x01\n" +
	"\x1aProtoOAUnsubscribeSpotsReq\x12U\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1ePROTO_OA_UNSUBSCRIBE_SPOTS_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	...
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12.\n" +
	"\x06period\x18\x03 \x02(\x0e2\x16.ProtoOATrendbarPeriodR\x06period\x12\x1a\n" +
	"\bsymbolId\x18\x04 \x02(\x03R\bsymbolId\"\xb0\x01\n" +
	"\x1fProtoOASubscribeLiveTrendbarRes\x12[\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:$PROTO_OA_SUBSCRIBE_LIVE_TRENDBAR_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\x80\x02\n" +
	"!ProtoOAUnsubscribeLiveTrendbarReq\x12]\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:&PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12.\n" +
	"\x06period\x18\x03 \x02(\x0e2\x16.ProtoOATrendbarPeriodR\x06period\x12\x1a\n" +
	"\bsymbolId\x18\x04 \x02(\x03R\bsymbolId\"\xb4\x01\n" +
	"!ProtoOAUnsubscribeLiveTrendbarRes\x12]\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:&PROTO_OA_UNSUBSCRIBE_LIVE_TRENDBAR_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xc7\x02\n" +
	"\x16ProtoOAGetTrendbarsReq\x12Q\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1aPROTO_OA_GET_TRENDBARS_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12$\n" +
	"\rfromTimestamp\x18\x03 \x01(\x03R\rfromTimestamp\x12 \n" +
	"\vtoTimestamp\x18\x04 \x01(\x03R\vtoTimestamp\x12.\n" +
	"\x06period\x18\x05 \x02(\x0e2\x16.ProtoOATrendbarPeriodR\x06period\x12\x1a\n" +
	"\bsymbolId\x18\x06 \x02(\x03R\bsymbolId\x12\x14\n" +
	"\x05count\x18\a \x01(\rR\x05count\"\xd3\x02\n" +
	"\x16ProtoOAGetTrendbarsRes\x12Q\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1aPROTO_OA_GET_TRENDBARS_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12.\n" +
	"\x06period\x18\x03 \x02(\x0e2\x16.ProtoOATrendbarPeriodR\x06period\x12 \n" +
	"\ttimestamp\x18\x04 \x01(\x03B\x02\x18\x01R\ttimestamp\x12,\n" +
	"\btrendbar\x18\x05 \x03(\v2\x10.ProtoOATrendbarR\btrendbar\x12\x1a\n" +
	"\bsymbolId\x18\x06 \x01(\x03R\bsymbolId\x12\x18\n" +
	"\ahasMore\x18\a \x01(\bR\ahasMore\"\xa6\x02\n" +
	"\x15ProtoOAGetTickDataReq\x12P\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x19PROTO_OA_GET_TICKDATA_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	"\bsymbolId\x18\x03 \x02(\x03R\bsymbolId\x12%\n" +
	"\x04type\x18\x04 \x02(\x0e2\x11.ProtoOAQuoteTypeR\x04type\x12$\n" +
	"\rfromTimestamp\x18\x05 \x01(\x03R\rfromTimestamp\x12 \n" +
	"\vtoTimestamp\x18\x06 \x01(\x03R\vtoTimestamp\"\xe3\x01\n" +
	"\x15ProtoOAGetTickDataRes\x12P\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x19PROTO_OA_GET_TICKDATA_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12,\n" +
	"\btickData\x18\x03 \x03(\v2\x10.ProtoOATickDataR\btickData\x12\x18\n" +
	"\ahasMore\x18\x04 \x02(\bR\ahasMore\"\xa2\x01\n" +
	"\x1fProtoOAGetCtidProfileByTokenReq\x12]\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:&PROTO_OA_GET_CTID_PROFILE_BY_TOKEN_REQR\vpayloadType\x12 \n" +
	"\vaccessToken\x18\x02 \x02(\tR\vaccessToken\"\xaf\x01\n" +
	"\x1fProtoOAGetCtidProfileByTokenRes\x12]\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:&PROTO_OA_GET_CTID_PROFILE_BY_TOKEN_RESR\vpayloadType\x12-\n" +
	"\aprofile\x18\x02 \x02(\v2\x13.ProtoOACtidProfileR\aprofile\"\x8a\x02\n" +
	"\x11ProtoOADepthEvent\x12K\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x14PROTO_OA_DEPTH_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	"\bsymbolId\x18\x03 \x02(\x04R\bsymbolId\x120\n" +
	"\tnewQuotes\x18\x04 \x03(\v2\x12.ProtoOADepthQuoteR\tnewQuotes\x12(\n" +
	"\rdeletedQuotes\x18\x05 \x03(\x04B\x02\x10\x01R\rdeletedQuotes\"\xca\x01\n" +
	"\x1eProtoOASubscribeDepthQuotesReq\x12Z\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:#PROTO_OA_SUBSCRIBE_DEPTH_QUOTES_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	"\bsymbolId\x18\x03 \x03(\x03R\bsymbolId\"\xae\x01\n" +
	"\x1eProtoOASubscribeDepthQuotesRes\x12Z\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:#PROTO_OA_SUBSCRIBE_DEPTH_QUOTES_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xce\x01\n" +
	" ProtoOAUnsubscribeDepthQuotesReq\x12\\\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:%PROTO_OA_UNSUBSCRIBE_DEPTH_QUOTES_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1a\n" +
	"\bsymbolId\x18\x03 \x03(\x03R\bsymbolId\"\xb2\x01\n" +
	" ProtoOAUnsubscribeDepthQuotesRes\x12\\\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:%PROTO_OA_UNSUBSCRIBE_DEPTH_QUOTES_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xa5\x01\n" +
	"\x1cProtoOASymbolCategoryListReq\x12S\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1cPROTO_OA_SYMBOL_CATEGORY_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xe5\x01\n" +
	"\x1cProtoOASymbolCategoryListRes\x12S\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1cPROTO_OA_SYMBOL_CATEGORY_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12>\n" +
	"\x0esymbolCategory\x18\x03 \x03(\v2\x16.ProtoOASymbolCategoryR\x0esymbolCategory\"\x9f\x01\n" +
	"\x17ProtoOAAccountLogoutReq\x12R\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1bPROTO_OA_ACCOUNT_LOGOUT_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\x9f\x01\n" +
	"\x17ProtoOAAccountLogoutRes\x12R\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1bPROTO_OA_ACCOUNT_LOGOUT_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xab\x01\n" +
	"\x1dProtoOAAccountDisconnectEvent\x12X\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:!PROTO_OA_ACCOUNT_DISCONNECT_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xa2\x01\n" +
	"\x18ProtoOAMarginCallListReq\x12T\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_MARGIN_CALL_LIST_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xa4\x01\n" +
	"\x18ProtoOAMarginCallListRes\x12T\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_MARGIN_CALL_LIST_RESR\vpayloadType\x122\n" +
	"\n" +
	"marginCall\x18\x02 \x03(\v2\x12.ProtoOAMarginCallR\n" +
	"marginCall\"\xda\x01\n" +
	"\x1aProtoOAMarginCallUpdateReq\x12V\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1fPROTO_OA_MARGIN_CALL_UPDATE_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x122\n" +
	"\n" +
	"marginCall\x18\x03 \x02(\v2\x12.ProtoOAMarginCallR\n" +
	"marginCall\"t\n" +
	"\x1aProtoOAMarginCallUpdateRes\x12V\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1fPROTO_OA_MARGIN_CALL_UPDATE_RESR\vpayloadType\"\xde\x01\n" +
	"\x1cProtoOAMarginCallUpdateEvent\x12X\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:!PROTO_OA_MARGIN_CALL_UPDATE_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x122\n" +
	"\n" +
	"marginCall\x18\x03 \x02(\v2\x12.ProtoOAMarginCallR\n" +
	"marginCall\"\xe0\x01\n" +
	"\x1dProtoOAMarginCallTriggerEvent\x12Y\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\"PROTO_OA_MARGIN_CALL_TRIGGER_EVENTR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x122\n" +
	"\n" +
	"marginCall\x18\x03 \x02(\v2\x12.ProtoOAMarginCallR\n" +
	"marginCall\"\xce\x01\n" +
	" ProtoOAGetDynamicLeverageByIDReq\x12X\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:!PROTO_OA_GET_DYNAMIC_LEVERAGE_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1e\n" +
	"\n" +
	"leverageId\x18\x03 \x02(\x03R\n" +
	"leverageId\"\xe3\x01\n" +
	" ProtoOAGetDynamicLeverageByIDRes\x12X\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:!PROTO_OA_GET_DYNAMIC_LEVERAGE_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x123\n" +
	"\bleverage\x18\x03 \x02(\v2\x17.ProtoOADynamicLeverageR\bleverage\"\x98\x02\n" +
	"\x1eProtoOADealListByPositionIdReq\x12\\\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:%PROTO_OA_DEAL_LIST_BY_POSITION_ID_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1e\n" +
	"\n" +
	"positionId\x18\x03 \x02(\x03R\n" +
	"positionId\x12$\n" +
	"\rfromTimestamp\x18\x04 \x01(\x03R\rfromTimestamp\x12 \n" +
	"\vtoTimestamp\x18\x05 \x01(\x03R\vtoTimestamp\"\xec\x01\n" +
	"\x1eProtoOADealListByPositionIdRes\x12\\\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:%PROTO_OA_DEAL_LIST_BY_POSITION_ID_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12 \n" +
	"\x04deal\x18\x03 \x03(\v2\f.ProtoOADealR\x04deal\x12\x18\n" +
	"\ahasMore\x18\x04 \x02(\bR\ahasMore\"\xb7\x01\n" +
	"\x16ProtoOAOrderDetailsReq\x12Q\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1aPROTO_OA_ORDER_DETAILS_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x18\n" +
	"\aorderId\x18\x03 \x02(\x03R\aorderId\"\xe4\x01\n" +
	"\x16ProtoOAOrderDetailsRes\x12Q\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1aPROTO_OA_ORDER_DETAILS_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12#\n" +
	"\x05order\x18\x03 \x02(\v2\r.ProtoOAOrderR\x05order\x12 \n" +
	"\x04deal\x18\x04 \x03(\v2\f.ProtoOADealR\x04deal\"\x9a\x02\n" +
	"\x1fProtoOAOrderListByPositionIdReq\x12]\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:&PROTO_OA_ORDER_LIST_BY_POSITION_ID_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x1e\n" +
	"\n" +
	"positionId\x18\x03 \x02(\x03R\n" +
	"positionId\x12$\n" +
	"\rfromTimestamp\x18\x04 \x01(\x03R\rfromTimestamp\x12 \n" +
	"\vtoTimestamp\x18\x05 \x01(\x03R\vtoTimestamp\"\xf1\x01\n" +
	"\x1fProtoOAOrderListByPositionIdRes\x12]\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:&PROTO_OA_ORDER_LIST_BY_POSITION_ID_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12#\n" +
	"\x05order\x18\x03 \x03(\v2\r.ProtoOAOrderR\x05order\x12\x18\n" +
	"\ahasMore\x18\x04 \x02(\bR\ahasMore\"\xba\x01\n" +
	"\x18ProtoOADealOffsetListReq\x12T\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_DEAL_OFFSET_LIST_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12\x16\n" +
	"\x06dealId\x18\x03 \x02(\x03R\x06dealId\"\x86\x02\n" +
	"\x18ProtoOADealOffsetListRes\x12T\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:\x1dPROTO_OA_DEAL_OFFSET_LIST_RESR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\x12.\n" +
	"\boffsetBy\x18\x03 \x03(\v2\x12.ProtoOADealOffsetR\boffsetBy\x122\n" +
	"\n" +
	"offsetting\x18\x04 \x03(\v2\x12.ProtoOADealOffsetR\n" +
	"offsetting\"\xb7\x01\n" +
	"\"ProtoOAGetPositionUnrealizedPnLReq\x12_\n" +
	"\vpayloadType\x18\x01 \x01(\x0e2\x13.ProtoOAPayloadType:(PROTO_OA_GET_POSITION_UNREALIZED_PNL_REQR\vpayloadType\x120\n" +
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountId\"\xae\x02\n" +
	...
	"\x13ctidTraderAccountId\x18\x02 \x02(\x03R\x13ctidTraderAccountIdBL\n" +
	"\x1fcom.xtrader.protocol.openapi.v2B\x1aContainerOpenApiV2MessagesP\x01Z\b/openapi\xa0\x01\x01"
