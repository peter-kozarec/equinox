...
func New(v int64, precision int) Point {
	return Point{true, must(decimal.New(v, precision))}
}

func FromUint(v uint64, precision int) Point {
	return Point{true, must(decimal.New(int64(v), precision))}
}
...
func (p Point) Div(o Point) Point { return Point{true, must(p.v.Quo(o.v))} }
...
func (p Point) Abs() Point     { return Point{true, p.v.Abs()} }
func (p Point) Neg() Point     { return Point{true, p.v.Neg()} }
...
func (p Point) Pow(o Point) Point { return Point{true, must(p.v.Pow(o.v))} }
func (p Point) Sqrt() Point       { return Point{true, must(p.v.Sqrt())} }

func (p Point) Exp() Point { return Point{true, must(p.v.Exp())} }
func (p Point) Log() Point { return Point{true, must(p.v.Log())} }

func (p Point) Rescale(scale int) Point { return Point{true, p.v.Rescale(scale)} }
